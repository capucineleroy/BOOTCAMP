            ...
            <article key={order.id} className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-6 flex flex-wrap justify-end gap-3">
                <Link
                  ...
                  className="inline-flex items-center justify-center px-5 py-3 rounded-lg bg-[#015A52] px-5 py-2 text-sm font-semibold text-white transition hover:bg-[#026b6b]"
                >
                  Réparer
                </Link>
              </div>
